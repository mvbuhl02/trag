...
<head>
    ...
    <title>Cadastrar Manutenção - TagTrack</title>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="id_bem" class="form-select" required>
                                ...
                                <?php foreach ($bens as $bem): ?>
                                    <option value="<?= $bem['id_bem'] ?>" <?= ($dados['id_bem'] ?? '') == $bem['id_bem'] ? 'selected' : '' ?>>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="tipo" class="form-control" 
                                   value="<?= htmlspecialchars($dados['tipo'] ?? '') ?>" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="id_fornecedor" class="form-select">
                                ...
                                <?php foreach ($fornecedores as $fornecedor): ?>
                                    <option value="<?= $fornecedor['id_fornecedor'] ?>" <?= ($dados['id_fornecedor'] ?? '') == $fornecedor['id_fornecedor'] ? 'selected' : '' ?>>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="status" class="form-select">
                                <?php foreach ($statusList as $value => $label): ?>
                                    <option value="<?= $value ?>" <?= ($dados['status'] ?? 1) == $value ? 'selected' : '' ?>>
                                        <?= $label ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="col-12">
                            ...
                            <select name="id_usuario_responsavel" class="form-select">
                                ...
                                <?php foreach ($usuarios as $usuario): ?>
                                    <option value="<?= $usuario['id_usuario'] ?>" <?= ($dados['id_usuario_responsavel'] ?? '') == $usuario['id_usuario'] ? 'selected' : '' ?>>
