...
// Verifica autenticação (exemplo básico)
/*
...
try {
    ...
    $stmtDepartamentos = $pdo->query("SELECT COUNT(*) AS total FROM departamento");
    $totalDepartamentos = $stmtDepartamentos->fetch()['total'];
    ...
    $totalBens = $totalCategorias = $totalSetores = $totalDepartamentos = $totalUsuarios = 0;
}
?>
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="d-flex gap-2 flex-wrap">
                            <a href="novo_bem.php" class="btn btn-primary">
            ...
            <div class="card-body">
                ...
                try {
                    $stmtUltimosBens = $pdo->query("
                        SELECT b.nome, c.nome AS categoria, s.nome AS setor, b.data_adicao 
                        FROM bem b
